package com.cardprototype.core.domain.ability;
...
public class Ability {
	...
	private List<AbilityCategory> categories;
	...
	public static final int BUFF_STANDARD = 2;
	public static final int BUFF_MAJOR = 3;

	public static final int BUFF_LENGTH = 3;
	...
	public String getStats() {
		...
		if(getCooldown()-1 > 0) {
			sBuffer.append(", " + (getCooldown()-1) + " turn" + (((getCooldown()-1) != 1) ? "s" : "") + " of cooldown");
		}
	...
	public List<AbilityCategory> getCategories() {
		return categories;
	}

	public void setCategories(List<AbilityCategory> categories) {
